...
namespace Thesis.Migrations
{
    ...
    [Migration("20230612134254_mail2")]
    partial class mail2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Thesis.Areas.Forum.Models.Post", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Thesis.Models.Calendar.Reminder", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Thesis.Models.MailCredentials", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Thesis.Models.ReviewComment", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Thesis.Models.Calendar.Reminder", b =>
                {
                    ...
                    b.HasOne("Thesis.Models.ApplicationUser", "user")
                        .WithMany()
                        .HasForeignKey("userId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Thesis.Models.ReviewComment", b =>
                {
                    b.HasOne("Thesis.Models.Answer", "answer")
                        .WithMany("comments")
